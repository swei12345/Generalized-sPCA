...
### Caution: Sourcing the algorithms from `IPsPCA.R` may cause Warning on variable length mismatch. But runing the scripts below directly doesn't.
...
IPsPCA <- function(S, v, G, tau, max_it = 20){
  Q <-  v   ### need to check if Q full-column rank
  T_t <-  S %*% Q
  t <-  0
